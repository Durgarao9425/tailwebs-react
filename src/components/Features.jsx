...
const Features = () => {
  return (
    <section className="features-section pb-5 position-relative" style={{ marginBottom: '80px', zIndex: 5 }}>
      <div className="container bg-white rounded-4 py-5 px-4 px-lg-5 position-relative fade-in-up visible mx-auto"
        style={{ marginTop: '-100px', zIndex: 100, boxShadow: '0 15px 45px rgba(0,0,0,0.1)', width: '92%' }}>
